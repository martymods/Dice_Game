...
let currentBet = 0; // Store the bet for multiplayer
...
function startSinglePlayer() {
    ...
    // You can add more logic for rolling the dice here
...
function handleBets(outcome) {
    // Update player balances based on the outcome of the roll
    ...
    // Update the betting area display
