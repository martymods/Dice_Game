...
async function setupSinglePlayer() {
    ...
    try {
        ...
        itemPool = module.default || module.items;
    } catch (error) {
        console.error('Error loading items.js:', error);
        return;
    }
    ...
    function showItemPopup() {
        ...
        const shuffledItems = itemPool.sort(() => 0.5 - Math.random()).slice(0, 3);
