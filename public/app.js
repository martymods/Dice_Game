...
function setupSinglePlayer() {
    ...
    rollButton.addEventListener('click', () => {
        if (currentBet > 0) {
            ...
            if (sum === 7 || sum === 11) {
                balance += currentBet * 2; // Double the bet amount
            ...
            if (turns >= maxTurns) {
                if (balance >= rent) {
                    ...
                    turns = 0;
                    progression++;
                    alert(`You paid the rent! 🎉 Your landlord says: "I see you making money, and I want my cut. Rent is now $${rent}. Pay up or else!"`);
                } else {
                    showLeaderboard(balance);
                }
            }
    ...
    function displayLeaderboard() {
        ...
        leaderboard.innerHTML = `
            ...
            ${top20
                ...
                .join('')}
            <button id="mainMenuButton">Return to Main Menu</button>
        `;
        document.getElementById('mainMenuButton').addEventListener('click', quitGame);
    }
}

// Multiplayer Setup (Placeholder)
