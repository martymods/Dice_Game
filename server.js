...
io.on('connection', (socket) => {
    ...
    socket.on('createGame', (data) => {
        console.log(`Creating game. Room: ${data.roomName}, Player: ${data.playerName}`);
    ...
    socket.on('joinGame', (data) => {
        console.log(`Player ${data.playerName} attempting to join game: ${data.roomName}`);
    ...
    socket.on('rollDice', (data) => {
        console.log(`Rolling dice in room: ${data.roomName} with bet: ${data.bet}`);
        const room = rooms[data.roomName];
        if (room) {
